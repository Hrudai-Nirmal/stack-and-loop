...
import { StaticLoopVisual } from "@/components/loop-visual";
...
export default function Home() {
  return (
    <div className="page-shell">
      <section className="container relative min-h-[calc(100vh-9rem)] border-b hairline pb-24 md:pb-28">
        <div className="grid min-h-[calc(100vh-17rem)] items-center gap-8 lg:grid-cols-[1fr_0.95fr]">
          <div className="max-w-3xl reveal">
            <h1 className="text-6xl leading-[1.12] font-semibold text-balance text-white md:text-7xl">
              Smarter systems.
              <br />
              Less busywork.
            </h1>
            <p className="mt-9 max-w-2xl text-2xl leading-9 text-[var(--soft)] md:text-[1.65rem] md:leading-10">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/contact"
                className="inline-flex h-16 items-center justify-center gap-4 rounded-lg bg-white px-8 text-base font-medium text-black transition hover:bg-white/88 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white/70"
              >
                Send project brief
              ...
              <Link
                href="/process"
                className="inline-flex h-16 items-center justify-center gap-4 rounded-lg border hairline px-8 text-base font-medium text-white/90 transition hover:border-white/35 hover:bg-white/[0.04] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white/70"
              >
                See how it works
                <ArrowRight size={20} aria-hidden />
              </Link>
