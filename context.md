...
- Theme direction: add a light/dark mode switch on the right side of the header. Light mode uses `#eff1ed`, `#373d20`, `#717744`, `#bcbd8b`, and `#766153`; dark mode uses black, white, `#1a535c`, and `#4ecdc4` accents. The logo and theme switch stay neutral rather than accent-colored.
