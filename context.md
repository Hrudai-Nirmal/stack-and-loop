...
- Use a premium theme system inspired by Linear but distinct: crisp typography, subtle loop motif, low cognitive load, restrained motion, a calm olive/cream light mode, and a black/white/electric-cyan dark mode.
...
- Theme direction: add a light/dark mode switch beside the header logo. Light mode uses `#606c38`, `#283618`, and `#fefae0`; dark mode uses black, white, and electric cyan accents.
