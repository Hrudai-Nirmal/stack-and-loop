...
- Theme direction: add a light/dark mode switch on the right side of the header. Light mode uses `#2C3930`, `#3F4F44`, `#A27B5C`, and `#DCD7C9`; dark mode uses black, white, `#1a535c`, and `#4ecdc4` accents. The logo and theme switch stay neutral rather than accent-colored.
