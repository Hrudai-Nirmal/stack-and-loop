...
- Process Step 2 refinement: module boxes are drawn first, the base/crease lines are derived around their footprints, and each module has a small processor-chip mark on its top face.
