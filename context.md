...
- Accent color experiment: use `#1f7a8c` as the sitewide accent for active navigation, focus rings, CTAs, selected states, diagram highlights, animated beams, and small interface emphasis while keeping the broader site black/gray/white.
