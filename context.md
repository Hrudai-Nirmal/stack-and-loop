...
- AI beam visual direction: the task boxes rotate through realistic automatable tasks/tools such as lead intake, Gmail triage, form replies, research, Slack routing, sheet updates, and CRM cleanup. Use library icons where appropriate and small realistic-color custom SVGs for tool marks that are not available locally.
